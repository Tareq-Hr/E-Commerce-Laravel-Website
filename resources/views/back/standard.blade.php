        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-body">
              ...
              <b>Confirmer la suppression</b>
              <br><br>
              <p>Veuillez vraiment supprimer cet champs définitivement !?</p>
            </div>
            <div class="modal-footer">
              <a type="button" class="btn btn-danger" id="delete_confirm_btn" href="">Oui, Supprimer</a>
